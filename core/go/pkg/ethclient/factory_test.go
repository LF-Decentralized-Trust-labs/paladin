...
type mockEth struct {
	eth_getBalance            func(context.Context, types.EthAddress, string) (*types.HexUint256, error)
	eth_gasPrice              func(context.Context) (*types.HexUint256, error)
	eth_gasLimit              func(context.Context, ethsigner.Transaction) (*types.HexUint256, error)
	eth_chainId               func(context.Context) (types.HexUint64, error)
	eth_getTransactionCount   func(context.Context, types.EthAddress, string) (types.HexUint64, error)
	eth_getTransactionReceipt func(context.Context, types.Bytes32) (*txReceiptJSONRPC, error)
	eth_estimateGas           func(context.Context, ethsigner.Transaction) (types.HexUint64, error)
...
func newTestServer(t *testing.T, ctx context.Context, isWS bool, mEth *mockEth) (rpcServer rpcserver.RPCServer, done func()) {
	...
	if mEth.eth_chainId == nil {
		mEth.eth_chainId = func(ctx context.Context) (types.HexUint64, error) {
			return 12345, nil
		}
	}
...
func TestNewEthClientFactoryChainIDFail(t *testing.T) {
	...
	rpcServer, done := newTestServer(t, ctx, false, &mockEth{
		eth_chainId: func(ctx context.Context) (types.HexUint64, error) { return 0, fmt.Errorf("pop") },
	})
	defer done()
...
func TestMismatchedChainID(t *testing.T) {
	ctx := context.Background()
	mEthHTTP := &mockEth{
		eth_chainId: func(ctx context.Context) (types.HexUint64, error) { return 22222, nil },
	}
	mEthWS := &mockEth{
		eth_chainId: func(ctx context.Context) (types.HexUint64, error) { return 11111, nil },
	}
