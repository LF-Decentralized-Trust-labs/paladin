...
func TestGetTransactionCountFailForBuildRawTx(t *testing.T) {
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_getTransactionCount: func(ctx context.Context, ah types.EthAddress, s string) (types.HexUint64, error) {
...
func TestGetBalance(t *testing.T) {
	balanceHexInt := (*types.HexUint256)(big.NewInt(200000))
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_getBalance: func(ctx context.Context, ah types.EthAddress, s string) (*types.HexUint256, error) {
			return balanceHexInt, nil
		},
	})
	defer done()

	balance, err := ec.HTTPClient().GetBalance(ctx, *types.MustEthAddress("0x1d0cD5b99d2E2a380e52b4000377Dd507c6df754"), "latest")
...
func TestGetBalanceFail(t *testing.T) {
	...
	_, err := ec.HTTPClient().GetBalance(ctx, *types.MustEthAddress("0x1d0cD5b99d2E2a380e52b4000377Dd507c6df754"), "latest")
	assert.Regexp(t, "pop", err)

}

func TestGasPrice(t *testing.T) {
	gasPriceHexInt := (*types.HexUint256)(big.NewInt(200000))
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_gasPrice: func(ctx context.Context) (*types.HexUint256, error) {
...
func TestEstimateGas(t *testing.T) {
	gasEstimateHexInt := types.HexUint64(200000)
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_estimateGas: func(ctx context.Context, tx ethsigner.Transaction) (types.HexUint64, error) {
	...
	require.NoError(t, err)
	assert.Equal(t, gasEstimateHexInt, types.HexUint64(res.GasLimit.Uint64()))
...
func TestGetTransactionCount(t *testing.T) {
	txCountHexUint := (types.HexUint64)(200000)
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_getTransactionCount: func(ctx context.Context, addr types.EthAddress, block string) (types.HexUint64, error) {
			return txCountHexUint, nil
		},
	})
	defer done()

	txCount, err := ec.HTTPClient().GetTransactionCount(ctx, *types.MustEthAddress("0x1d0cD5b99d2E2a380e52b4000377Dd507c6df754"))
	require.NoError(t, err)
...
func TestGetTransactionCountFail(t *testing.T) {
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_getTransactionCount: func(ctx context.Context, addr types.EthAddress, block string) (types.HexUint64, error) {
			return (types.HexUint64)(0), fmt.Errorf("pop")
		},
	})
	defer done()

	_, err := ec.HTTPClient().GetTransactionCount(ctx, *types.MustEthAddress("0x1d0cD5b99d2E2a380e52b4000377Dd507c6df754"))
	assert.Regexp(t, "pop", err)
}
...
func TestBuildRawTransactionEstimateGasFail(t *testing.T) {
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		...
		eth_estimateGas: func(ctx context.Context, t ethsigner.Transaction) (types.HexUint64, error) {
			return 0, fmt.Errorf("pop1")
		},
		eth_call: func(ctx context.Context, t ethsigner.Transaction, s string) (types.HexBytes, error) {
			return nil, fmt.Errorf("pop2")
...
func TestGetReceiptOkSuccess(t *testing.T) {
	...
	ctx, ec, done := newTestClientAndServer(t, &mockEth{
		eth_getTransactionReceipt: func(context.Context, types.Bytes32) (*txReceiptJSONRPC, error) {
