...
type DBEntry struct {
	...
	Updated          types.Timestamp `gorm:"column:updated;autoUpdateTime:nano"`
	Active           bool            `gorm:"column:active"`
	ParentID         types.HexBytes  `gorm:"column:parent_id"`
...
type DBProperty struct {
	Registry         string          `gorm:"column:registry;primaryKey"`
	EntryID          types.HexBytes  `gorm:"column:entry_id;primaryKey"`
