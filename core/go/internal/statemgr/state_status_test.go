...
func genWidget(t *testing.T, schemaID types.Bytes32, txID *uuid.UUID, withoutSalt string) *components.StateUpsert {
...
func makeWidgets(t *testing.T, ctx context.Context, ss *stateManager, domainName string, contractAddress *types.EthAddress, schemaID types.Bytes32, withoutSalt []string) []*pldapi.State {
...
func newTestDomainContext(t *testing.T, ctx context.Context, ss *stateManager, name string, customHashFunction bool) (*types.EthAddress, *domainContext) {
