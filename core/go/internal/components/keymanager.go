...
type KeyManager interface {
	...
	ResolveEthAddressNewDatabaseTX(ctx context.Context, identifier string) (ethAddress *types.EthAddress, err error)

	// Convenience when all you want is the EthAddress, and to know the reverse lookup will later be possible
	ResolveEthAddressBatchNewDatabaseTX(ctx context.Context, identifiers []string) (ethAddresses []*types.EthAddress, err error)
