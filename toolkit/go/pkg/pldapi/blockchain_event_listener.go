...
type BlockchainEventListener struct {
	...
	Created tktypes.Timestamp               `docstruct:"BlockchainEventListener" json:"created"`
...
type BlockchainEventListenerSource struct {
	...
	Address *tktypes.EthAddress `docstruct:"BlockchainEventListenerSource" json:"address,omitempty"`
}
