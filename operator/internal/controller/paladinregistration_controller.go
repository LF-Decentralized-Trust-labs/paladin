...
func (r *PaladinRegistrationReconciler) getRegistryAddress(ctx context.Context, reg *corev1alpha1.PaladinRegistration) (*commontypes.EthAddress, error) {
	...
	return commontypes.ParseEthAddress(registry.Status.ContractAddress)

}

func (r *PaladinRegistrationReconciler) buildRegistrationTX(ctx context.Context, reg *corev1alpha1.PaladinRegistration, registryAddr *commontypes.EthAddress) (bool, *pldapi.TransactionInput, error) {
	...
	registration := map[string]any{
		"parentIdentityHash": commontypes.Bytes32{}, // zero for root
		"name":               nodeName,
		"owner":              addr,
	}
	...
	tx := &pldapi.TransactionInput{
		TransactionBase: pldapi.TransactionBase{
			...
			Data:     commontypes.JSONString(registration),
		},
		ABI: registryABI,
	}
...
func (r *PaladinRegistrationReconciler) buildTransportTX(ctx context.Context, reg *corev1alpha1.PaladinRegistration, registryAddr *commontypes.EthAddress, transportName string) (bool, *pldapi.TransactionInput, error) {
	...
	tx := &pldapi.TransactionInput{
		TransactionBase: pldapi.TransactionBase{
			...
			Data:     commontypes.JSONString(property),
		},
		ABI: registryABI,
	}
