...
interface IConfidentialTokenLockable is IConfidentialToken {
    ...
    /**
     * @dev Spend states and create new locked states.
     ...
     *      control of the states can be delegated to another address.
     *
     ...
     * @param states the input and output states (see LockStates struct - note that inputs must
     *               be only unlocked states)
    ...
    /**
     * @dev Directly create new locked states.
    ...
    /**
     * @dev Spend locked states and create new (locked or unlocked) states.
     *
     * @param txId a unique identifier for this transaction which must not have been used before
     * @param lockId unique identifier for the lock
     * @param states the input and output states (see LockStates struct - note that inputs must be
     *               only locked states)
     * @param proof implementation-specific proof for this transaction - may be validated by
     *              the smart contract, or may represent evidence of off-chain validation
     * @param data any additional transaction data (opaque to the blockchain)
     ...
     * @param txId a unique identifier for this transaction which must not have been used before
     * @param lockId unique identifier for the lock
     * @param lockedInputs array of zero or more states locked by the given lockId
