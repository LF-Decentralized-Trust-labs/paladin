...
func TestReceiptTransfers(t *testing.T) {
	...
	owner1 := commontypes.MustEthAddress("0xbb2b99dde4ca2d4c99f149d13cd55a9edada69eb")
	owner2 := commontypes.MustEthAddress("0x3008ee73a70cd1cc57647c7d253a48defe86dd9b")
	owner3 := commontypes.MustEthAddress("0xea82df8cb94b9fa1a0a711d75a7f7dfdec2ef53c")
	...
	assert.ElementsMatch(t, []*types.ReceiptTransfer{{
		From:   nil,
		To:     owner1,
		Amount: commontypes.Int64ToInt256(1),
	}}, transfers)
	...
	assert.ElementsMatch(t, []*types.ReceiptTransfer{{
		From:   owner1,
		To:     nil,
		Amount: commontypes.Int64ToInt256(2),
	}}, transfers)
