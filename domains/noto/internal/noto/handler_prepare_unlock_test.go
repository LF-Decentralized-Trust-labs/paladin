...
func TestPrepareUnlock(t *testing.T) {
	...
	unlockHash, err := n.unlockHashFromStates(ctx, ethtypes.MustNewAddress(contractAddress), readStates, nil, n.filterSchema(infoStates, []string{"coin"}), commontypes.MustParseHexBytes("0x1234"))
	require.NoError(t, err)
