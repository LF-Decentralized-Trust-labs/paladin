...
func (h *lockHandler) hookInvoke(ctx context.Context, lockID commontypes.Bytes32, tx *types.ParsedTransaction, req *prototk.PrepareTransactionRequest, baseTransaction *TransactionWrapper) (*TransactionWrapper, error) {
...
func (h *lockHandler) extractLockID(ctx context.Context, req *prototk.PrepareTransactionRequest) (commontypes.Bytes32, error) {
	...
	if len(lockStates) == 1 {
		...
		if err != nil {
			return commontypes.Bytes32{}, err
		}
		return lock.LockID, nil
	}
	return commontypes.Bytes32{}, i18n.NewError(ctx, msgs.MsgLockIDNotFound)
}
