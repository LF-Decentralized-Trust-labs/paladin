...
func (n *Noto) findEthAddressVerifier(ctx context.Context, label, lookup string, verifierList []*prototk.ResolvedVerifier) (*commontypes.EthAddress, error) {
	...
	return commontypes.ParseEthAddress(verifier.Verifier)
}
...
type TransactionWrapper struct {
	...
	paramsJSON      []byte
	contractAddress *commontypes.EthAddress
}
