...
func TestMintHandler_Prepare(t *testing.T) {
	...
	tests := []struct {
		name         string
		encodeFunc   func(context.Context, *pb.TransactionSpecification) (commontypes.HexBytes, error)
			...
			params: []*types.NonFungibleTransferParamEntry{
				{
					To:      "",
					URI:     "https://example.com",
					TokenID: (*commontypes.HexUint256)(big.NewInt(0)), // zero is acceptable
				},
			},
			expectErr: true,
		},
			...
			params: []*types.NonFungibleTransferParamEntry{
				{
					To:      "recipient",
					URI:     "https://example.com",
					TokenID: (*commontypes.HexUint256)(big.NewInt(123)), // non-zero tokenID is not allowed for mint
				},
			},
			expectErr: true,
		},
			...
			params: []*types.NonFungibleTransferParamEntry{
				{
					To:      "recipient",
					URI:     "",
					TokenID: (*commontypes.HexUint256)(big.NewInt(0)), // zero tokenID is acceptable
				},
			},
			expectErr: true,
		},
