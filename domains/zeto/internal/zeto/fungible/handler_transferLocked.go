...
func (h *transferLockedHandler) Init(ctx context.Context, tx *types.ParsedTransaction, req *pb.InitTransactionRequest) (*pb.InitTransactionResponse, error) {
	...
	_, err := commontypes.ParseEthAddress(params.Delegate)
	if err != nil {
...
func (h *transferLockedHandler) loadCoins(ctx context.Context, ids []*commontypes.HexUint256, useNullifiers bool, stateQueryContext string) ([]*types.ZetoCoin, []*pb.StateRef, error) {
