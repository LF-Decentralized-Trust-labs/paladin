...
func TestValidateAmountParam(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "zero amount",
			amount:      (*commontypes.HexUint256)(big.NewInt(0)),
			index:       1,
			expectErr:   true,
		...
		},
		{
			...
			amount:      (*commontypes.HexUint256)(big.NewInt(-100)),
			index:       2,
			expectErr:   true,
			errContains: "PD210027", // MsgParamAmountInRange
		},
...
func TestValidateTransferParams(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			params: []*types.FungibleTransferParamEntry{
				{To: "", Amount: (*commontypes.HexUint256)(big.NewInt(100))},
			},
			expectErr:   true,
		...
		},
		{
			...
			params: []*types.FungibleTransferParamEntry{
				{To: "recipient1", Amount: (*commontypes.HexUint256)(big.NewInt(0))},
			},
			expectErr:   true,
			errContains: "PD210027", // MsgParamAmountInRange
		},
		{
			...
			params: []*types.FungibleTransferParamEntry{
				{To: "recipient1", Amount: (*commontypes.HexUint256)(big.NewInt(-500))},
			},
			expectErr:   true,
			errContains: "PD210027", // MsgParamAmountInRange
		},
		{
			...
			params: []*types.FungibleTransferParamEntry{
				{To: "recipient1", Amount: (*commontypes.HexUint256)(big.NewInt(6000))},
				{To: "recipient2", Amount: (*commontypes.HexUint256)(big.NewInt(5000))}, // total 11000 > MAX_TRANSFER_AMOUNT
			},
			expectErr:   true,
		...
		},
		{
			...
			params: []*types.FungibleTransferParamEntry{
				{To: "recipient1", Amount: (*commontypes.HexUint256)(big.NewInt(3000))},
				{To: "recipient2", Amount: (*commontypes.HexUint256)(big.NewInt(4000))},
				{To: "recipient3", Amount: (*commontypes.HexUint256)(big.NewInt(2000))}, // total 9000 < MAX_TRANSFER_AMOUNT
			},
			expectErr: false,
		},
	}
